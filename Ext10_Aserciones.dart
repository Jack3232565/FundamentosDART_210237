void main() {
  ...
  print("""
Lado del Cuadrado: ${mySquare._side}       // Usando el getter para obtener el valor del lado
Área que ocupa: ${mySquare.calcularArea()}  // Llamando al método calcularArea para obtener el área
""");

final mySquare2 = Square(side: -7);
print("""El area del cuadrado es de : ${mySquare2._side}
su aprea es de: ${mySquare2.calcularArea()}""");
...
class Square {
  ...
  Square({required double side}) 
    : assert(side > 0, 'side debe ser mayor a 0'), // Aplicación de la aserción o regla de negocio
      _side = side;
